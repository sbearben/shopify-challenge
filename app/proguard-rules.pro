...
-keepclassmembers class uk.co.victoriajanedavis.shopify_challenge.data.model.** {
...
-keepclassmembers class uk.co.victoriajanedavis.shopify_challenge.data.remote.ShopifyService$** {
    !static !private <fields>;
}
